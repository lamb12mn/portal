  ...
  <div>
      ...
      <div class="container-custom py-16 md:py-24 flex flex-col md:flex-row items-center justify-between relative z-10">
        <div class="md:w-[45%] lg:w-[48%] mb-12 md:mb-0">
          ...
          <h1 class="mb-6 leading-tight">
            {{ t('home.hero.title') }}<span class="relative inline-block tech-gradient">
              <span class="absolute inset-0 bg-primary-100/50 transform -skew-x-12 -z-10 rounded"></span>
            </span>
            <br />{{ t('home.hero.subtitle') }}<span class="relative tech-gradient">
              <span class="absolute -bottom-1 left-0 w-full h-3 bg-secondary-200/50 -z-10 transform skew-x-3"></span>
            </span>
          </h1>
          <p class="text-xl text-gray-600 mb-8 max-w-md">{{ t('home.hero.detailedDesc') }}</p>
          <div class="flex flex-wrap gap-4">
            ...
            <router-link to="/applicationField" class="btn btn-outline">{{ t('nav.applicationField') }}</router-link>
          </div>
          ...
          <div class="mt-6 flex flex-wrap gap-2">
            <span class="text-xs py-1 px-3 bg-primary-100 text-primary-700 rounded-full">现代化</span>
            <span class="text-xs py-1 px-3 bg-secondary-100 text-secondary-700 rounded-full">专业加工</span>
            <span class="text-xs py-1 px-3 bg-accent-100 text-accent-700 rounded-full">技术成熟</span>
            <span class="text-xs py-1 px-3 bg-gray-100 text-gray-700 rounded-full">新三板</span>
          </div>
        </div>
          ...
          <div class="relative z-20 mx-auto md:max-w-[90%] lg:max-w-full">
            ...
            <div class="card-glass relative overflow-hidden z-10">
              <div class="relative overflow-hidden rounded-2xl aspect-[4/3] md:aspect-[16/10]">
                <!-- 明显的边框效果 -->
                <div class="absolute inset-0 rounded-2xl animate-pulse border-2 border-primary-500/50" style="box-shadow: 0 0 5px 2px rgba(99, 102, 241, 0.5);"></div>
                <!-- 使用高质量开源AI技术相关图片替换 -->
                <img src="../assets/images/home/banner01.jpg" alt="AI技术未来" class="w-full h-full object-cover relative z-10" />
                ...
                <div class="absolute bottom-0 left-0 w-full h-16 bg-gradient-to-t from-black/50 to-transparent flex items-end p-4 z-30">
                  <div class="text-white text-sm tracking-wider typing-effect" style="text-shadow: 0 1px 2px rgba(0,0,0,0.3)">{{ t('home.heroImage.slogan') }}</div>
                </div>
      ...
      <div class="container-custom relative z-10">
        <div class="text-center mb-12">
          <div class="inline-flex items-center justify-center mb-3">
            ...
            <span class="mx-3 text-sm font-semibold text-primary-600 uppercase tracking-wide">{{ t('home.features.sectionSubtitle') }}</span>
            <span class="h-px w-8 bg-gradient-to-l from-transparent to-primary-300"></span>
          </div>
          <h2 class="mb-4">{{ t('home.features.sectionTitle') }}</h2>
          <p class="text-gray-600 max-w-2xl mx-auto">{{ t('home.features.description') }}</p>
        </div>
            ...
            <div class="card h-full flex flex-col bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
              <div class="h-48 bg-gray-100 overflow-hidden relative">
                ...
                <div class="absolute top-3 left-3 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1 text-xs text-primary-700 font-medium border border-primary-100 shadow-sm">
                  {{ t('home.features.productBadges')[index] }}
                </div>
              </div>
      ...
      <div class="container-custom relative z-10">
        <div class="text-center mb-12">
          <div class="inline-flex items-center justify-center mb-3">
            ...
            <span class="mx-3 text-sm font-semibold text-secondary-600 uppercase tracking-wide">聚焦核心</span>
            <span class="h-px w-8 bg-gradient-to-l from-transparent to-secondary-300"></span>
          </div>
          <h2 class="mb-4">产能布局</h2>
          <p class="text-gray-600 max-w-2xl mx-auto">我们实现了实现了从材料研发、零部件加工到系统集成的全产业链覆盖</p>
        </div>
    ...
    <section class="section relative">
      ...
      <div class="container-custom relative z-10">
        <div class="text-center mb-12">
          <div class="inline-flex items-center justify-center mb-3">
            <span class="h-px w-8 bg-gradient-to-r from-transparent to-secondary-300"></span>
            <span class="mx-3 text-sm font-semibold text-secondary-600 uppercase tracking-wide">{{ t('home.projects.sectionSubtitle') }}</span>
            <span class="h-px w-8 bg-gradient-to-l from-transparent to-secondary-300"></span>
          </div>
          <h2 class="mb-4">{{ t('home.projects.sectionTitle') }}</h2>
          <p class="text-gray-600 max-w-2xl mx-auto">{{ t('home.projects.description') }}</p>
        </div>
      ...
      <div class="container-custom relative z-10">
        <div class="text-center mb-12">
          <div class="inline-flex items-center justify-center mb-3">
            ...
            <span class="mx-3 text-sm font-semibold text-accent-600 uppercase tracking-wide">{{ t('home.media.sectionSubtitle') }}</span>
            <span class="h-px w-8 bg-gradient-to-l from-transparent to-accent-300"></span>
          </div>
          <h2 class="mb-4">{{ t('home.media.sectionTitle') }}</h2>
          <p class="text-gray-600 max-w-2xl mx-auto">{{ t('home.media.description') }}</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div class="card overflow-hidden group glow-effect transform transition-all duration-300 hover:-translate-y-1">
            ...
            <div class="p-6 relative">
              ...
              <h3 class="text-xl font-bold mb-2 group-hover:text-primary-600 transition-colors">{{ t('home.media.bilibiliVideo.title') }}</h3>
              <p class="text-gray-600 mb-4">{{ t('home.media.bilibiliVideo.description') }}</p>
          ...
          <div class="card overflow-hidden group glow-purple transform transition-all duration-300 hover:-translate-y-1">
            ...
            <div class="p-6 relative">
              ...
              <h3 class="text-xl font-bold mb-2 group-hover:text-secondary-600 transition-colors">{{ t('home.media.douyinVideo.title') }}</h3>
              <p class="text-gray-600 mb-4">{{ t('home.media.douyinVideo.description') }}</p>
    ...
    <section class="section bg-gradient-tech relative overflow-hidden">
      ...
      <div class="container-custom text-center relative z-10">
        ...
        <p class="text-white text-opacity-90 text-xl mb-8 max-w-2xl mx-auto">{{ t('home.contact.description') }}</p>
        ...
        <div class="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
          <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
            ...
            <div class="text-white/80 text-sm">{{ t('home.contact.stats.support') }}</div>
          </div>
          <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
            <div class="text-2xl font-bold text-white mb-1">50+</div>
            <div class="text-white/80 text-sm">{{ t('home.contact.stats.cases') }}</div>
          </div>
          <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
            <div class="text-2xl font-bold text-white mb-1">10年+</div>
            <div class="text-white/80 text-sm">{{ t('home.contact.stats.experience') }}</div>
          </div>
          <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
            <div class="text-2xl font-bold text-white mb-1">98%</div>
            <div class="text-white/80 text-sm">{{ t('home.contact.stats.satisfaction') }}</div>
          </div>
        </div>
      </div>
    </section>
...
const featuredProducts = computed(() => [
  {
    id: 'watermark',
    title: t('home.featuredProducts.watermark.title'),
    description: t('home.featuredProducts.watermark.description'),
    image: 'https://images.pexels.com/photos/5473955/pexels-photo-5473955.jpeg?auto=compress&cs=tinysrgb&w=1080',
    category: 'ai-tools'
  },
  {
    id: 'legal-eye',
    title: t('home.featuredProducts.legalEye.title'),
    description: t('home.featuredProducts.legalEye.description'),
    image: 'https://images.pexels.com/photos/265087/pexels-photo-265087.jpeg?auto=compress&cs=tinysrgb&w=600',
    category: 'enterprise'
  },
  {
    id: 'id-photo',
    title: t('home.featuredProducts.idPhoto.title'),
    description: t('home.featuredProducts.idPhoto.description'),
...
const openSourceProjects = computed(() => [
  {
    id: 'litemes',
    name: t('home.openSourceProjects.litemes.name'),
    description: t('home.openSourceProjects.litemes.description'),
    tags: ['JavaScript', 'Vue'],
    link: 'https://github.com/freeleepm/LiteMES'
  },
  {
    id: 'freesign',
    name: t('home.openSourceProjects.freesign.name'),
  ...
  {
    id: 'miniContract',
    name: t('home.openSourceProjects.miniContract.name'),
